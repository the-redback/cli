...
import (
	...
	"github.com/kubedb/cli/pkg/databases"
...
//err = sh.Command("psql","--host=127.0.0.1",fmt.Sprintf("--port=%d", tunnel.Local),"--username=postgres").Command("CREATE DATABASE guru99;").Run()
